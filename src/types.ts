export type QuestionType='binary'|'ranking';export type RoomPhase='lobby'|'answering'|'reveal';
...
export interface Answer{ id?:string; room_id:string; question_id:string; player_id:string; choice?:string; ranking?:string[]; comment?:string|null }
